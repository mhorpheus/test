...
![Identifying caller number](screenshotsPagerDuty-identify-caller.png)
...
![PagerDuty Schedule view](screenshotsPagerDuty_schedule_view.png)
...
![Initial configuration of PagerDuty](screenshotsPagerDuty-initial-config1.png)
...
![Finding VoiceMail messages in PagerDuty](screenshotsPagerDuty-voicemail1.png)
4. Click on "Listen to Recording".
![Listening to VoiceMail messages in PagerDuty](screenshotsPagerDuty-voicemail2.png)
...
![Exporting on-call calendar feed in PagerDuty](screenshotsPagerDuty-calendar-feed.png)
...
![Identifying current on-call person](screenshotsPagerDuty-who-is-on-call.png)
