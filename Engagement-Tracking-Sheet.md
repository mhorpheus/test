...
- Step 12.3: Obtain and populate "When collected" in ETS: Evidence
...
- Step 33.5: Extract and Analyse all Malware samples or tools used by Threat Actor
	- Follow detailed process on handling malware and tools documented [below](#Malware-and-Tools-Tab).
- Step 33.6: Document analysis in “Individual System Investigation Sheet”
- Step 33.7: Mark notable timeline events in the “Individual System Investigation Sheet”
	- Follow guidelines documented in [below section](#Individual-System-Timeline-Tab) on how to tag events as notable.
- Step 35.1: Populate summary note in Slack thread for evidence item
	- Update "Investigation Status Note" within Slack Thread.
- Step 40.2: Merge notable events of individual system timeline to “ETS: timeline”
...
- Step 9: Place sample (zip + password) to “Case Folder/Malware”:
...
- Step 12: Submit sample to IMPE Sandbox:
	- Follow instruction on how to use [IMPE Sandbox](Threat-Intel-for-IR#Sandbox).
- Step 15.1: Create RE Resilient ticket:
